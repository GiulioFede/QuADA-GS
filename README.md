...
> 💡 **Note:** When dealing with very small inputs (e.g., $32 \times 24$) and/or extreme scaling ratios, consider raising the $dmax$ for all levels. This adjustment trades off some inference speed to maintain structural continuity, effectively avoiding spatial gaps in the reconstructed image.
